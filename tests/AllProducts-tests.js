...
import {fetchProducts} from '../client/store/products'
...
const {db, Product} = require('../server/db/models/product')
...
describe('Tier One: All Products', () => {
  ...
  describe('<AllProducts /> component', () => {
    ...
    it('renders the campuses passed in as props', () => {
      ...
      expect(wrapper.text()).to.include('Orange Juice')
      expect(wrapper.text()).to.include('Apple Juice')
